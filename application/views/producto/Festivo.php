<div id="content" class="content">
   <ol class="breadcrumb pull-right">
      ...
      <li class="breadcrumb-item active"><a href="<?php echo base_url();?>Productos/Postres">PRODUCTOS FESTIVOS</a></li>
   </ol>
   <h1 class="page-header">PRODUCTOS FESTIVOS</h1>
   <div class="row">
      <div class="col-lg-12">
         <div class="panel panel-inverse">
            <div class="panel-heading">
               <h4 class="panel-title">REGISTRAR PRODUCTOS FESTIVOS</h4>
            </div>
      ...
      <div class="col-lg-12">
         <div class="panel panel-inverse">
            <div class="panel-heading">
               ...
               <h4 class="panel-title">LISTADO DE FESTIVO</h4>
            </div>
            <div class="panel-body">
