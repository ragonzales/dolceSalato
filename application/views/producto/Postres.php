<div id="content" class="content">
    <ol class="breadcrumb pull-right">
        ...
        <li class="breadcrumb-item active"><a href="<?php echo base_url();?>Productos/Postres">POSTRES</a></li>
    </ol>
    <h1 class="page-header">POSTRES Y TORTAS</h1>
    <div class="row">			    
        <div class="col-lg-12">
            <div class="panel panel-inverse">
                <div class="panel-heading">
                    <h4 class="panel-title">REGISTRAR PRODUCTOS</h4>
                </div>
        ...
        <div class="col-lg-12">
            <div class="panel panel-inverse">
                <div class="panel-heading">
                    ...
                    <h4 class="panel-title">LISTA DE POSTRES</h4>
                </div>
